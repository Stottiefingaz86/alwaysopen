export const en = {
  ...
  hero: {
    ...
    bullets: [
      ...
      "Confirmation SMS and reminders",
      "Follow-up and repeat customer campaigns",
  ...
  industries: {
    ...
    salonWorkflow: {
      ...
      pipelineTitle: "Booking automation pipeline",
      flowBadge: "Confirmation + marketing",
      footnote:
        "The agent asks whether to confirm by WhatsApp or email. After a successful book, a 30-day rebook campaign runs in parallel.",
      callPath: {
        customerCall: "Customer calls",
        yourNumber: "Your business number",
        yourNumberHint: "Same number on Google & signage",
        ...
        voiceAgentHint: "Answers 24/7 in EN / ES",
        knowledgeBase: "Business knowledge base",
        knowledgeBaseHint: "Services, availability, FAQs, policies",
      },
      nodes: {
        webhook: "ElevenLabs Webhook",
        routeByAction: "Route by action",
        routeHint: "mode: Rules",
        branchCheck: "Check availability",
        ...
        emailCancelNotice: "Email cancellation notice",
        whatsappCancelNotice: "WhatsApp cancellation notice",
        respondAvailability: "Respond availability",
    ...
    items: {
      ...
      salon: {
        ...
        modalDescription:
          "Speak with the AI receptionist for Brows by Sarah. Allow the microphone when prompted.",
        prompts: [
          "I'd like to book a brow appointment",
  ...
  phone: {
    ...
    title: "How RingsAway helps grow your business",
    ...
    steps: [
      ...
      {
        title: "RingsAway answers and captures bookings",
        text: "RingsAway answers questions, checks availability, books appointments or reservations and captures enquiries automatically.",
        badge: "AI active 24/7",
      },
      {
        title: "Automatic confirmations and reminders",
        text: "Customers automatically receive confirmations and reminders through SMS, WhatsApp or email to reduce no-shows and improve experience.",
        badge: "SMS • WhatsApp • Email",
      },
      {
        title: "Follow-up and repeat customer campaigns",
        text: "After a visit, RingsAway can send follow-ups, aftercare information and repeat booking campaigns.",
        badge: "Customer retention automation",
        examples: [
          { industry: "Salon", quote: "Your colour refresh is due in 6 weeks" },
          { industry: "Restaurant", quote: "New seasonal menu available" },
          { industry: "Clinic", quote: "How are you feeling after your treatment?" },
        ],
      },
      {
        title: "Understand what customers are saying",
        text: "Monthly Voice of Customer reports analyse reviews and customer feedback to identify complaints, trends and actions that improve your business.",
        badge: "Monthly VoC insights",
      },
    ],
    step: "Step",
  ...
  footer: {
    ...
    followUs: "Follow us",
    instagramLabel: "RingsAway on Instagram",

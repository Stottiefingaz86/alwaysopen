export const en = {
  ...
  pricing: {
    ...
    subtitle: "Three plans. Clear outcomes. No surprises.",
    cancelAnytime: "No subscriptions. Cancel anytime.",
    popular: "Most popular",
    setup: "Setup",
    perMonth: "/mo",
    overage: "Overage:",
    questions: "Questions?",
    talkLink: "Talk over coffee ☕",
    minutes: {
      starter: "150 minutes/month",
      growth: "400 minutes/month",
      premium: "1000 minutes/month",
    },
    overageRates: {
      starter: "€0.35/minute",
      growth: "€0.30/minute",
  ...
  addOns: {
    title: "Add-ons",
    subtitle: "One-off services when you need an extra push. No subscription.",
    items: [
      { title: "1 VoC report", price: "€299" },
      { title: "1 competitor analysis", price: "€349" },
      { title: "1 CX audit", price: "€499" },
    ],
  },
  about: {
    eyebrow: "About us",

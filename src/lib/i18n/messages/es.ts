export const es = {
  ...
  hero: {
    eyebrow: "Para salones, clínicas, oficios y comercios locales",
    title: "Tu línea telefónica, atendida",
    titleHighlight: "24/7",
    subtitle:
      "Los clientes llaman a tu número habitual. RingsAway contesta y reserva citas. Cada mes preparamos un informe de opinión del cliente (VoC): qué dicen, qué corregir y cómo actuar en Google.",
    bullets: [
      "Atiende tu número real de negocio 24/7",
      "Captura reservas automáticamente",
      "Informes mensuales de opinión del cliente (VoC)",
    ],
  ...
  phone: {
    ...
    title: "Llamadas reales. Atendidas por IA.",
    subtitle:
      "RingsAway está pensado para cómo te contactan los clientes locales: marcando tu número de negocio.",
    badge: "Tu número real",
    lineLabel: "Tu línea de negocio",
    lineCaption: "El mismo número en Google, web y escaparate",
    flowGoogle: "Google",
    flowLine: "Tu línea",
    flowBrand: "RingsAway",
    flowBadge: "Línea activa 24/7",
    clarifiers: [
      "Funciona con tu número de negocio actual",
      "Quien llama usa móvil o fijo",
      "No es un chatbot web ni una app que instale el cliente",
    ],
    steps: [
      {
        title: "Los clientes llaman a tu número",
        text: "Marcan el mismo número de Google, tu web o el escaparate. Una llamada normal.",
      },
      {
        title: "Tu recepcionista IA contesta",
        text: "RingsAway atiende, resuelve consultas, reserva citas y responde preguntas frecuentes.",
        badge: "Recepcionista IA en tu línea",
      },
      {
        title: "Tú sigues informado",
        text: "Las reservas van al calendario y recibes resúmenes de lo que pidieron.",
      },
    ],
    step: "Paso",
  },
  trust: {
    title: "Todo lo que debería hacer tu recepción",
    subtitle:
      "IA en el teléfono e informes mensuales redactados por personas, sin contratar a otra persona en mostrador.",
    items: [
      "No pierdas consultas",
      "Disponible 24/7",
      "Informes de opinión del cliente",
      "Informes preparados a mano",
  ...
  solution: {
    eyebrow: "La solución",
    title: "Un sistema para llamadas, reseñas e insight del cliente",
    subtitle:
      "IA en tu línea telefónica, más informes mensuales de opinión del cliente con acciones claras y plan de Google Business.",
    coreBadge: "Producto principal",
    coreTitle: "Recepcionista IA",
    coreTagline: "Tu número de negocio, atendido 24/7",
    coreFeatures: [
      "Atiende tu línea telefónica real",
      "Reserva citas y responde FAQs",
      "Envía confirmaciones automáticamente",
    ],
    coreNoteBefore: "El núcleo de RingsAway: cada llamada llega a un agente formado en",
    coreNoteEmphasis: "tu",
    coreNoteAfter: "número.",
    howItWorks: "Cómo funciona",
    liveOnLine: "Activo en tu línea",
    pickup: "Atención 24/7",
    aiTrained: "IA formada",
    pillar1Title: "Informes de reseñas y feedback",
    pillar1Tagline: "Insight humano, no puntuaciones automáticas",
    pillar1Desc:
      "Leemos tu perfil de Google Business, comentarios web y encuestas, y resumimos quejas, elogios y tendencias en lenguaje claro.",
    pillar1Highlights: ["Reseñas Google y web", "Feedback de encuestas", "Redactado por nuestro equipo"],
    pillar1Cta: "Cómo funcionan los informes",
    pillar2Title: "Opinión del cliente (VoC)",
    pillar2Tagline: "Escucha, actúa, crece en Google",
    pillar2Desc:
      "Voz del Cliente en términos claros: leemos lo que dicen, explicamos por qué importa y enviamos un plan mensual más estrategia de Google Business, preparado por nuestro equipo, no por software.",
    pillar2Highlights: ["Informes en lenguaje claro", "Plan Google Business", "Acciones priorizadas"],
    pillar2Cta: "¿Qué es VoC?",
    chartLabel: "Temas del mes",
    chartTrend: "↑ Mejorando",
    sampleActions: ["Responder reseñas de 3 estrellas", "Publicar sobre horario nocturno"],
    rating: "4.8",
  },
  pipeline: {
    eyebrow: "Cómo funciona",
    title: "Cómo RingsAway trabaja para tu negocio",
    subtitle: "De cada punto de contacto a acciones claras, en un flujo conectado.",
    inLabel: "Entrada",
  ...
  pricing: {
    ...
    subtitle: "Tres planes. Resultados claros. Sin sorpresas.",
    cancelAnytime: "Sin suscripciones. Cancela cuando quieras.",
    popular: "Más popular",
    setup: "Configuración",
    perMonth: "/mes",
    overage: "Exceso:",
    questions: "¿Preguntas?",
    talkLink: "Hablemos con un café ☕",
    minutes: {
      starter: "150 minutos/mes",
      growth: "400 minutos/mes",
      premium: "1000 minutos/mes",
    },
    overageRates: {
      starter: "0,35 €/minuto",
      growth: "0,30 €/minuto",
    ...
    prices: {
      starter: { setup: "750 €", monthly: "199 €" },
      growth: { setup: "1250 €", monthly: "399 €" },
      premium: { setup: "2500 €", monthly: "799 €" },
    },
    plans: {
      starter: {
        name: "Starter",
        includes: [
          ...
          "Resumen mensual básico de reseñas",
        ],
      },
      growth: {
        name: "Growth",
        includes: [
          "Todo Starter",
          "Mejor base de conocimiento",
          "Automatización de reservas",
          "Enlaces de calendario",
          "Informe mensual de opinión del cliente",
          "Plan de acción Google Business",
      ...
      premium: {
        ...
        includes: [
          "Todo Growth",
          "Varios calendarios",
          "Informe profundo + estrategia Google",
          "Benchmark de competencia",
          "Auditoría CX trimestral",
  ...
  addOns: {
    title: "Complementos",
    subtitle: "Servicios puntuales cuando necesitas un impulso extra. Sin suscripción.",
    items: [
      { title: "1 informe VoC", price: "299 €" },
      { title: "1 análisis de competencia", price: "349 €" },
      { title: "1 auditoría CX", price: "499 €" },
    ],
  },
  about: {
    eyebrow: "Nosotros",

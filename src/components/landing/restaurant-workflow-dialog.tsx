...
import { RestaurantWorkflowDiagram } from "@/components/landing/restaurant-workflow-diagram";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
type RestaurantWorkflowDialogProps = {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  title: string;
};

export function RestaurantWorkflowDialog({
  open,
  onOpenChange,
  title,
}: RestaurantWorkflowDialogProps) {
  const { m } = useLocale();
